...
/*
Plugin Name: Zajax
Plugin URI: http://www.scriptsmashup.com/product/zajax-ajax-navigation-plugin-for-wordpress
...
function zajax_insert_header()
{
    ...
    <style>
        ...
        #nprogress .bar {
            background: # <?php echo $zajax_loading ?>;
        }

        #nprogress .peg {
            box-shadow: 0 0 10px # <?php echo $zajax_loading ?>, 0 0 5px # <?php echo $zajax_loading ?>;
        }
...
//get_bloginfo('url');
    ...
    <div class="wrap">
        <h2><span class="dashicons dashicons-update" style="line-height: inherit;"></span> <?php echo $plugin_name ?>
            Settings</h2><?php
        echo $message;
        ...
        if ($plugin_name != 'Zajax-Pro') { ?>
            <table class="wp-list-table widefat fixed bookmarks" style="margin-bottom: 20px;">
                ...
                <tbody>
                <tr>
                    <td><a style="float: left;margin-right: 50px;"
                           href="http://www.scriptsmashup.com/product/zajax-ajax-navigation-plugin-for-wordpress"
                           target="_blank"><img
                                src="http://www.scriptsmashup.com/wp-content/uploads/2015/12/square-banner-zajax-100px.png"></a>
                        <a href="http://www.scriptsmashup.com/product/zajax-ajax-navigation-plugin-for-wordpress"
                           target="_blank"><h3 style="color: #167CFF;margin-top: 0;">Get Zajax Pro</h3></a>
                        <ol>
                            <li>Preload page on mouse hover to load faster when user click on the link.</li>
                            <li>Reload multiple sections outside the main section by ID or Class. (Menu, footer,
                                sidebar, Ads, Google Ads). by just providing the ID/CLASS with #/. as prefix.
                            </li>
            ...
            <table class="wp-list-table widefat fixed bookmarks">
                ...
                <tr>
                    <th><?php echo $plugin_name ?> (version: <?php echo $plugin_version ?> )
                        ...
                        ?>
                        <a href="<?php echo plugins_url('rd.html', __FILE__); ?>?TB_iframe=true&width=600&height=550"
                           class="thickbox"><span class="dashicons dashicons-megaphone"></span> Help </a>
                        ...
                        <table class="form-table">
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="zajax[zajax_main]" class="none" id="none"
                                           value="<?php echo $zajax_main ?>"></input>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="zajax[zajax_main_mobile]" class="none" id="none"
                                           value="<?php echo $zajax_main_mobile ?>"></input>
                                </td>
                            </tr>
                            <!-- Others content Id or class -->
                            <th scope="row">other content ID or Class</th>
                            <td>
                                <span class="description wtf"> Enter one or many others elements to add who are external to the main content area that who want to reload EX: <strong>.menu,header,.widget-area</strong>. They should be outside the main container (you can mix with desktop and mobile version)</span><br
                                    class="wtf">
                                <a href="http://www.scriptsmashup.com/product/zajax-ajax-navigation-plugin-for-wordpress"
                                   target="_blank"><strong class="wth" style="color: #167CFF;">Pro Version Only</strong></a>
                                <input class="wtf" type="text" name="zajax[zajax_ClassID]" style="width:80%;"
                                       class="none" id="none" value="<?php echo $zajax_ClassID ?>"></input>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <span
                                        class="description"> Enter one or many search form id or and class EX: <strong>#searchform,.searchform</strong></span><br/>
                                    <input type="text" name="zajax[zajax_search]" style="width:80%;" class="none"
                                           id="none" value="<?php echo $zajax_search ?>"></input>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <input type="text" name="zajax[zajax_ignore]" style="width:80%;" class="none"
                                           id="none" value="<?php echo $zajax_ignore ?>"></input>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <span class="description"> Enter list of javascript file(s) to reload in the header separate by comma EX: <strong>mycustom.js,myslider.js
                                            (Tips: do not reload jquery plugins but reload the file(s) who call the
                                            functions to make these plugin work)</strong></span><br/>
                                    <input type="text" name="zajax[zajax_dolist]" style="width:80%;" class="none"
                                           id="none" value="<?php echo $zajax_dolist ?>"></input>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <span class="wtf"><br><br>Preload page on Mouse Hover: <input type="checkbox"
                                                                                                  name="zajax[zajax_preload]"
                                                                                                  value="0" <?php if ($zajax_preload == 1) { echo ' CHECKED="CHECKED" ';} ?> /></span>
                                    <a href="http://www.scriptsmashup.com/product/zajax-ajax-navigation-plugin-for-wordpress"
                                       target="_blank"><strong class="wth" style="color: #167CFF;">Pro Version
                                            Only</strong></a>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    <span class="description"> If your theme use the <strong><a
                                                href="http://masonry.desandro.com/" target="_blank">Masonry</a></strong> plugin we need to reload it. Find out the masonry container ID or Class and add it here. EX: </strong>
                                        #masonry-grid</strong></span><br/>
                                    <input type="text" name="zajax[zajax_masonry]" style="width:80%;" class="none"
                                           id="none" value="<?php echo $zajax_masonry ?>"></input>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    Show back button: <input type="checkbox" name="zajax[zajax_back]"
                                                             value="1" <?php if ($zajax_back == 1) {
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    Load all body: <input type="checkbox" name="zajax[zajax_body]"
                                                          value="1" <?php if ($zajax_body == 1) {
                                        echo ' CHECKED="CHECKED" ';
                                    } ?> />
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <textarea name="zajax_send" rows="10"
                                              style="width:100%"><?php echo $zajax_send ?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    ...
                                    <textarea name="zajax_complete" rows="10"
                                              style="width:100%"><?php echo $zajax_complete ?></textarea>
                                </td>
                            </tr>
                            ...
                            <tr valign="top">
                                ...
                                <td>
                                    # <input type="text" name="zajax[zajax_loading]" class="zajax_picker" id="picker"
                                             value="<?php echo $zajax_loading ?>"
                                             style="border-color: #<?php echo $zajax_loading ?>;"></input>
                                </td>
                            </tr>
